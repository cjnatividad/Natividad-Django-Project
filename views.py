...
def dmission(request):
    mission = """<b>MISSION</b> - The College of Computing and Multimedia Studies shall 
...
def dvision(request):
    vision = """<b>VISION</b> - The College of Computing and Multimedia Studies
...
def dobjects(request):
    objects = """<b>OBJECT</b> - After graduation, alumni of MSEUF-CSS program shall:<br><br>
